...
class ServerArgs:
    ...
    lora_paths: Optional[Union[dict[str, str], dict[str, LoRAInfo], List[str]]] = None
            ...
            if isinstance(self.lora_paths, list):
                ...
                for lora_path in lora_paths:
                    if "=" in lora_path:
                        ...
                        self.lora_paths[name] = LoRAInfo(lora_name=name, lora_path=path)
                    else:
                        self.lora_paths[lora_path] = LoRAInfo(
                            lora_name=path, lora_path=path
                        )
            elif isinstance(self.lora_paths, dict):
                self.lora_paths = {
                    k: LoRAInfo(lora_name=k, lora_path=v)
